...
export default function ExperiencedSection() {
    return (
        <div className='w-full mx-auto pt-10 pb-20 relative'>
            <div className='hidden md:block border md:h-[250px]  absolute lg:h-[280px] xl:h-[330px] 2xl:h-[330px] md:border md:right-[32px] md:bottom-[60px] border-pink lg:right-[36px] 2xl:right-[200px]'></div>
            <div className='hidden md:block md:w-6 md:h-6 rounded-full  bg-pink absolute md:right-[20px] md:bottom-10  lg:right-[24px] lg:bottom-10 2xl:right-[189px]'></div>
            <div className='hidden md:block md:w-6 md:h-6 rounded-full  bg-pink absolute md:right-[21px] md:bottom-[310px]  lg:right-[25px] lg:bottom-[340px] xl:bottom-[380px] 2xl:right-[189px]'></div>
